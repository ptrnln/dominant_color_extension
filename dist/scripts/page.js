(function () {
	...
	***************************************************************************** */
	...
	var require$$0 = /*@__PURE__*/getAugmentedNamespace(html2canvas_esm);
	...
	*/
	...
	function requirePage () {
		...
		hasRequiredPage = 1;
		var __awaiter = (page$1.__awaiter) || function (thisArg, _arguments, P, generator) {
		    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
		    return new (P || (P = Promise))(function (resolve, reject) {
		        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
		        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
		...
		var __generator = (page$1.__generator) || function (thisArg, body) {
		    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
		    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
		    function verb(n) { return function (v) { return step([n, v]); }; }
		    function step(op) {
		...
		var _this = page$1;
		(function () { return __awaiter(_this, undefined, undefined, function () {
		    var html2canvas;
		    var _this = this;
		    return __generator(this, function (_a) {
		        switch (_a.label) {
		            case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require$$0; })];
		            case 1:
		                html2canvas = (_a.sent())["default"];
		                console.log(html2canvas);
		                document.addEventListener("DOMContentLoaded", function (e) { return __awaiter(_this, undefined, undefined, function () {
		                    var getDominantColor, mostCommon;
		                    var _this = this;
		                    return __generator(this, function (_a) {
		                        switch (_a.label) {
		                            case 0:
		                                e.preventDefault();
		                                getDominantColor = function () { return __awaiter(_this, undefined, undefined, function () {
		                                    var canvas, context, imageData, data, mostCommon, i, mostOccurances, colors, r, g, b, a;
		                                    return __generator(this, function (_a) {
		                                        switch (_a.label) {
		                                            case 0: return [4 /*yield*/, html2canvas(document.body)];
		                                            case 1:
		                                                canvas = _a.sent();
		                                                context = canvas.getContext("2d");
		                                                imageData = context.getImageData(0, 0, canvas.width, canvas.height);
		                                                data = imageData.data;
		                                                for (i = 0, mostOccurances = undefined, colors = {}; i < data.length; i += 4) {
		                                                    mostOccurances |= 0;
		                                                    r = data[i];
		                                                    g = data[i + 1];
		                                                    b = data[i + 2];
		                                                ...
		                                                return [2 /*return*/, mostCommon];
		                                        }
		                                    });
		                                }); };
		                                return [4 /*yield*/, getDominantColor()];
		                            case 1:
		                                mostCommon = _a.sent();
	...
	var pageExports = requirePage();
	var page = /*@__PURE__*/getDefaultExportFromCjs(pageExports);
