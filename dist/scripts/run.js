...
(function () {
    ...
    button.onclick = function () { return __awaiter(_this, void 0, void 0, function () {
        var currentTab, screenshot;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, chrome.tabs.query({ active: true, lastFocusedWindow: true })];
                case 1:
                    ...
                    if (currentTab) {
                        chrome["debugger"].detach({
                            ...
                            chrome["debugger"].attach({
                                tabId: currentTab.id
                            }, "1.3").then(function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
